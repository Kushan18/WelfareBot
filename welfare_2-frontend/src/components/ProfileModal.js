...
export default function ProfileModal({ sessionId, prefillName, onClose }) {
  const [form, setForm] = useState({ name: '', language_preference:'English', state:'', occupation:'', caste_category:'', gender:'', age:'', income_bracket:'', aadhaar:'', land_holding:'' });
      ...
      <div className='modal-box'>
        ...
        <form className='modal-form' onSubmit={handleSubmit}>
          <div className='form-grid'>
            ...
            <div className='form-field full'><label className='field-label'>Land Holding (acres, optional for farmers)</label><input type='text' value={form.land_holding} onChange={e => set('land_holding', e.target.value)} placeholder='e.g. 2.5 acres' /></div>
          </div>
